// The only timezone values the EqualReach project request accepts. Shared by
// the drafter's dropdown and the Gemini draft schema so the model can never
// invent a value the form can't represent.
